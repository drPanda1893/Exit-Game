...
public class BuildLevel3Library : EditorWindow
{
    ...
    private void AddHeliosSetup(Scene scene)
    {
        ...
        // Hinter dem Rückwandregal (z=5.4), zwischen Regal und Rückwand
        helios.transform.position = new Vector3(0f, groundY, 5.7f);
        ...
        spotGO.transform.position = new Vector3(0f, 5.5f, 5.7f);
        ...
        interGO.transform.position = new Vector3(0f, 1.0f, 4.8f);
