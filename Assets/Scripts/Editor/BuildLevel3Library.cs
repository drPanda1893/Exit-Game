...
public class BuildLevel3Library : EditorWindow
{
    ...
    private void AddHeliosSetup(Scene scene)
    {
        ...
        // Spielerseite des Rückwandregals (z=5.4), mittig, direkt im Sichtfeld beim Spawn
        helios.transform.position = new Vector3(0f, groundY, 4.5f);
        ...
        spotGO.transform.position = new Vector3(0f, 5.5f, 4.5f);
        ...
        interGO.transform.position = new Vector3(0f, 1.0f, 3.5f);
